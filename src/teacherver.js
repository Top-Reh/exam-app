...
const Teacherver = () => {
    ...
    useEffect(() => {
        ...
        fetch();
    }, [Answers, Delete,view,blankAnswers]);
                        ...
                        viewquestion.map((q, index) => (
                            q.type === 'multiple-choice' ? (
                                ...
                                >
                                    ...
                                    <input placeholder='Give mark' type='number' value={q.mark} onChange={(e) => handleInputChange(index, 'mark', e.target.value)} className='w-full p-2 rounded-md' />
                            ...
                            questionType === 'fill-in-the-blank' ? (
                                <form className='flex justify-center items-center gap-4 flex-col w-full' onSubmit={handleUpload}>
                                    ...
                                    <input placeholder='Give mark' type='number' className='w-full p-2 rounded-md' value={blankAnswers.mark} onChange={e => setBlankAnswers({ ...blankAnswers, mark: e.target.value })}></input>
                                ...
                                <form className='flex justify-center items-center gap-4 flex-col' onSubmit={handleUpload}>
                                    ...
                                    <input placeholder='Give mark' type='number' className='w-full p-2 rounded-md' value={Answers.mark} onChange={e => setAnswers({ ...Answers, mark: e.target.value })}></input>
                                    <button type="submit" className='bg-blue-500 text-white p-2 rounded'>Upload</button>
                                </form>
                            )
                    )
